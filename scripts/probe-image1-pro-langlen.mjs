/**
 * Probe whether English / byte-based prompts allow more detail than Chinese.
 * env -u ELECTRON_RUN_AS_NODE ./node_modules/.bin/electron scripts/probe-image1-pro-langlen.mjs
 */
...
function padZh(n) {
  const base = '一名年满21岁的成年日本女性，可爱东亚面孔，酒店客房自慰，16:9横构图，写实摄影，阴毛短整齐，真丝睡裙，暖金灯光。'
  let s = base
